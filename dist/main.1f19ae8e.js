...
var _default = exports.default = getRandomColor;
...
var _default = exports.default = BinaryTreeNode;
...
var _default = exports.default = BinarySearchTreeNode;
...
var _default = exports.default = getRGBString;
...
class ColorGenerator {
  ...
  getNextColor() {
    ...
    const color = (0, _getRGBString.default)(this.red, this.green, this.blue);
    // Increment the color
...
var _default = exports.default = ColorGenerator;
...
var _default = exports.default = CanvasComponent;
...
var _default = exports.default = connectPointsWithBezierCurve;
...
function drawPrettyBinaryTree(root, canvasComponent, options) {
  ...
  const {
    ...
    actualMaxHeight,
    actualMaxWidth
  } = (0, _tree.getRequiredAndActualHeightAndWidth)(maxNodeSpacing, heightOfTree, maxWidth, maxHeight);
  // Init calculation
...
var _default = exports.default = drawPrettyBinaryTree;
...
var _default = exports.default = drawExpandableBinaryTree;
...
function recursivelyDrawNodes(root, canvasComponent, currentLine, horizontalConfig) {
  ...
  // Y Calculation
  const yPosition = currentLine * _theme.default.lineHeight;
  // Draw the node
  root.nodeCircle.setCoordinates(xPosition, yPosition);
  root.nodeCircle.draw(canvasComponent);
...
function drawSimpleBinaryTree(root, canvasComponent, options) {
  ...
  const {
    ...
    actualMaxHeight,
    actualMaxWidth
  } = (0, _tree.getRequiredAndActualHeightAndWidth)(maxNumberOfLeafNodes, heightOfTree, maxWidth, maxHeight);
  // Init calculation
  const midPointInCanvas = actualMaxWidth / 2;
  const xStart = midPointInCanvas - maxCanvasWidthRequired / 2 + _theme.default.leafNodeSpace;
  const xEnd = midPointInCanvas + maxCanvasWidthRequired / 2 - _theme.default.leafNodeSpace;
  // Initialize the canvas
  canvasComponent.setMaxWidthAndHeight(actualMaxHeight, actualMaxWidth);
...
var _default = exports.default = drawSimpleBinaryTree;
...
var _default = exports.default = drawBinaryTree;
...
},{"./tree":"node_modules/binary-tree-visualizer/lib/tree/index.js","./canvas":"node_modules/binary-tree-visualizer/lib/canvas/index.js","./enumns":"node_modules/binary-tree-visualizer/lib/enumns/index.js","./config":"node_modules/binary-tree-visualizer/lib/config/index.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
(0, _binaryTreeVisualizer.setTheme)(opt);
var insertBtn = document.querySelector("button");
insertBtn.addEventListener("click", function () {
  if (root.value == " ") {
    root = new _binaryTreeVisualizer.BinaryTreeNode(parseInt(document.getElementById("element").value));
    draw();
  } else {
...
function insert(node, value) {
  ...
  if (value < node.value) {
    ...
    node.setLeft(new _binaryTreeVisualizer.BinaryTreeNode(value));
    return;
  }
  ...
  node.setRight(new _binaryTreeVisualizer.BinaryTreeNode(value));
}
function deleteNode(node, value) {
  ...
  if (value < node.value) {
    ...
    if (node.left == undefined) return node.right;else if (node.right == undefined) return node.left;
...
var deleteBtn = document.querySelectorAll("button")[1];
...
var searchBtn = document.querySelectorAll("button")[2];
searchBtn.addEventListener("click", function () {
  var value = parseInt(document.getElementById("element").value);
  if (isNaN(value)) return;
  var result = searchNode(root, value);
  var outputElement = document.getElementById("output_2");
  if (outputElement != undefined) outputElement.remove();
  var output_2 = document.createElement("h2");
  output_2.setAttribute("id", "output_2");
  var textnode = document.createTextNode(result ? "Node with value ".concat(value, " found.") : "Node with value ".concat(value, " not found."));
...
preorderBtn.addEventListener("click", function () {
  ...
  var output_1 = document.createElement("h2");
  output_1.setAttribute("id", "output_1");
  var textnode = document.createTextNode("Preorder: [");
...
inorderBtn.addEventListener("click", function () {
  ...
  var output_1 = document.createElement("h2");
  output_1.setAttribute("id", "output_1");
  var textnode = document.createTextNode("Inorder: [");
  output_1.appendChild(textnode);
...
postorderBtn.addEventListener("click", function () {
  ...
  var output_1 = document.createElement("h2");
  output_1.setAttribute("id", "output_1");
  var textnode = document.createTextNode("Postorder: [");
  output_1.appendChild(textnode);
...
var findMinBtn = document.getElementById("findMinBtn");
var findMaxBtn = document.getElementById("findMaxBtn");
findMinBtn.addEventListener("click", function () {
  var min = root.value !== " " ? minValue(root) : undefined;
  var outputElement = document.getElementById("output_3");
  if (outputElement != undefined) outputElement.remove();
  var output_3 = document.createElement("h2");
  output_3.setAttribute("id", "output_3");
  var textnode = document.createTextNode(min !== undefined ? "Min value: ".concat(min) : "Tree is empty.");
...
findMaxBtn.addEventListener("click", function () {
  var max = root.value !== " " ? maxValue(root) : undefined;
  var outputElement = document.getElementById("output_4");
  if (outputElement != undefined) outputElement.remove();
  var output_4 = document.createElement("h2");
  output_4.setAttribute("id", "output_4");
  var textnode = document.createTextNode(max !== undefined ? "Max value: ".concat(max) : "Tree is empty.");
  output_4.appendChild(textnode);
  document.getElementById("output").appendChild(output_4);
});
var resetBtn = document.getElementById("resetBtn");
resetBtn.addEventListener("click", function () {
  root = new _binaryTreeVisualizer.BinaryTreeNode(" ");
  draw();
  var outputElements = document.querySelectorAll('#output h2');
...
function draw() {
  (0, _binaryTreeVisualizer.drawBinaryTree)(root, document.querySelector("canvas"), {
    type: _binaryTreeVisualizer.VisualizationType.HIGHLIGHT
  });
}
var root = new _binaryTreeVisualizer.BinaryTreeNode(" ");
draw();
